...
const CompanionsPage = async ({ searchParams }: SearchParams) => {
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex justify-center">
              <Link href="/coaches/new" className="group relative">
                ...
                <button className="relative px-8 py-4 bg-slate-900 rounded-xl leading-none flex items-center gap-3 text-white font-medium transition-all duration-200 group-hover:bg-slate-800">
                  <svg className="h-5 w-5 text-purple-400 group-hover:text-purple-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  <span className="text-white group-hover:from-purple-300 group-hover:to-pink-300">
                    Create Your Own Coach
                  </span>
                  <svg className="h-4 w-4 text-slate-400 group-hover:text-slate-300 group-hover:translate-x-1 transition-all duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="container mx-auto px-6">
          {coaches.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <div className="space-y-4">
                <p className="text-slate-400 text-sm">Or create exactly what you need:</p>
                <Link href="/coaches/new" className="group relative inline-block">
                  ...
                  <button className="relative px-6 py-3 bg-slate-900 rounded-lg leading-none flex items-center gap-2 text-white font-medium transition-all duration-200 group-hover:bg-slate-800">
      ...
      {/* Contact CTA Section */}
      <section className="relative py-16 bg-none border-t border-slate-800/50">
        <div className="container mx-auto px-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative">
                  <div className="h-16 w-16 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-slate-700/50">
                    <svg className="h-8 w-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
                  <div className="absolute -top-1 -right-1 h-5 w-5 bg-green-500/20 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                  ...
                  <span className="text-slate-300 font-medium"> let us know!</span>
                </p>
              </div>
              ...
              <div className="pt-4">
                ...
                >
                  ...
                  <button className="relative px-8 py-4 bg-slate-900 rounded-lg leading-none flex items-center gap-3 text-white font-medium transition-all duration-200 group-hover:bg-slate-800 border border-slate-700/50 group-hover:border-slate-600/50">
                    ...
                    <span className="text-white group-hover:from-blue-300 group-hover:to-purple-300">
                      Request New Subject
                    </span>
                    <svg className="h-4 w-4 text-slate-400 group-hover:text-slate-300 group-hover:translate-x-1 transition-all duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
