    ...
    <section className="relative overflow-hidden w-full hero-container bg-none min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Enhanced Main Headline with Dynamic Effects */}
          <div className="relative mb-6">
            {/* Background Text Effect */}
            <div className="absolute inset-0 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-200/20 blur-sm">
             Create Personalized
              <br />
            ...
            {/* Main Text */}
            <h1 className={`relative text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <span className="block mb-2 relative">
                Create Personalized
                {/* Floating accent */}
                <div className="absolute -top-2 -right-4 w-3 h-3 bg-yellow-400 rounded-full animate-bounce opacity-80" style={{ animationDelay: '2s' }} />
              </span>
              <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent relative">
                Learning In The Blink Of An Eye
                {/* Sparkle effects */}
                <div className="absolute top-0 left-1/4 w-2 h-2 bg-cyan-400 rounded-full animate-ping opacity-60" style={{ animationDelay: '1s' }} />
                <div className="absolute bottom-0 right-1/3 w-2 h-2 bg-purple-400 rounded-full animate-ping opacity-60" style={{ animationDelay: '3s' }} />
              </span>
            </h1>
